...
class TempoViagem {
    ...
    public function tempoViagem($msg){
        ...
        if($driving->status == 'OK'){
            ...
            $local['driving']['duracao']['texto'] = $driving->rows[0]->elements[0]->duration->text;
        ...
        if($bicycling->status == 'OK'){
            ...
            $local['bicycling']['duracao']['texto'] = $bicycling->rows[0]->elements[0]->duration->text;
        ...
        if($walking->status == 'OK'){
            ...
            $local['walking']['duracao']['texto'] = $walking->rows[0]->elements[0]->duration->text;
