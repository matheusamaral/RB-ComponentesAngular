    ...
    public function consultar($usuarioId, $notIn){
        ...
        $query->select('u.id', 'usuarioId')
                ...
                ->add("case when u.ativo = 0 or b.id is not null then " . "'" . DOMINIO_PROJETO . "/ui/imagens/avatares/96.svg' "
                        . 'when men.usuario_id = ? and men.visibilidade_usuario_id = 2 then ' . "concat('" . DOMINIO_PROJETO . "',a.endereco) end "
                        . 'when men.usuario_id != ? and men.visibilidade_mensagens_id = 2 then ' . "concat('" . DOMINIO_PROJETO . "',a.endereco) end "
