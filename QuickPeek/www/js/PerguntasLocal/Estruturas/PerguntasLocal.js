...
.factory('PerguntasLocalHtml', [ function() {
    ...
    function montar() {
        return '<div class="row bar bar-header bar-positive">\n\
                ...
                <div ng-repeat="pergunta in dados.perguntas" \n\
                ...
                ng-if="dados.perguntas.length > 0">\n\
                    ...
                    <div ng-if="pergunta.respondida != 0" class="col remove-padding col-center">\n\
                    ...
                    <div style="padding-left:10px;" ng-if="pergunta.respondida == 0" class="col-25 remove-padding col-center">\n\
