...
angular.module('QuickPeek.HTML.FiltroMapa', [
])

.factory('FiltroMapaHtml', [function(){
       
    function montar(){
        return '<div class="config-padding-top row bar bar-header bar-light">\n\
                    <div class="col">\n\
                        <p class="p-titulo-barra-cinza">Categorias</p>\n\
                    </div>\n\
                    <div class="col">\n\
                    </div>\n\
                    <div class="col">\n\
                ...
                <div class="config-footer-cat bar bar-footer bar-light">\n\
                    <div class="col text-center">\n\
                        <button ng-click="voltarMapa()" class="tamanho-btn-footer btn-txt-direita button button-outline button-positive">\n\
                            CANCELAR\n\
                        </button>\n\
                    </div>\n\
                    <div class="col text-center">\n\
                        <button ng-click="aplicarFiltro()" class="tamanho-btn-footer btn-txt-direita button button-positive">\n\
                            APLICAR\n\
                        </button>\n\
                    </div>\n\
                </div>';
