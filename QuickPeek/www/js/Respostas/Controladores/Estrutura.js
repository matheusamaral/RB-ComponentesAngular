...
angular.module('QuickPeek.Estrutura.Respostas', [
    'RB.gcs',
    'RB.config',
    'RB.pagina',
...
.factory('RespostasEstrutura', ['GCS','Config','Pagina','VP',
    ...
    function popular(){
        ...
        if(DGlobal.respostas && DGlobal.respostas.success){
            if(DGlobal.respostas.dados.respostas)
                scope.dados.respostas = DGlobal.respostas.dados.respostas;
                scope.dados.pergunta = DGlobal.respostas.dados.pergunta;
        }
