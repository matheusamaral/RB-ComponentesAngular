...
.factory('ConfirmaNumeroRodape', [ function() {
    ...
    function montar() {
        return '<div class="bar bar-footer bar-positive" layout="row" layout-align="end center">\n\
                    <md-button layout="row" layout-align="center center" ng-click="cadastrarNumero()" class="btn-rodape remove-box-shadow btn-padrao largura-alto md-primary md-raised">\n\
